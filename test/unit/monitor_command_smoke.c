...
int main(void)
{
    static const monitor_command_case cases[] = {
        ...
        { APP_MONITOR_INIT, APP_MONITOR_COMMAND_PAUSE,
            APP_RECONCILER_INTENT_NONE, "Machine has not started.\r\n" },
        ...
        { APP_MONITOR_STOPPED, APP_MONITOR_COMMAND_PAUSE,
            APP_RECONCILER_INTENT_NONE, "Machine is stopped.\r\n" },
        ...
        { APP_MONITOR_PAUSED, APP_MONITOR_COMMAND_START,
            APP_RECONCILER_INTENT_NONE, "Machine is paused; use resume.\r\n" },
        { APP_MONITOR_PAUSED, APP_MONITOR_COMMAND_PAUSE,
            APP_RECONCILER_INTENT_NONE, "Machine is paused.\r\n" },
        ...
        { APP_MONITOR_RUNNING, APP_MONITOR_COMMAND_START,
            APP_RECONCILER_INTENT_NONE, "Machine is already running.\r\n" },
