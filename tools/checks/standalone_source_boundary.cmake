...
file(GLOB host_entries RELATIVE "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/*")
foreach(host_entry IN LISTS host_entries)
    if(IS_DIRECTORY "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/${host_entry}")
...
set(standalone_sources
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/ccpu/facade.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/cvidc/gdp_state.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/cvidc/gdp_state.h"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/cvidc/gdp_slots.h"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/softpc.new/base/cvidc/sascdef.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/softpc.new/base/support/ios.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/softpc.new/base/disks/fdisk.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/gfi_image.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/hdd_media.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/video.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/v7_pointer.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/memory.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/softpc.new/base/keymouse/keybd_io.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/softpc.new/base/system/idetect.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/device_bop.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/platform.c"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/machine/machine.c")

if(EXISTS "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/softpc_compat")
...
foreach(retired_machine_source IN ITEMS
    "src/app-softpc/compat/machine.c"
    "src/app-softpc/compat/machine.h"
    "src/app-softpc/product/command_binding.c"
    "src/app-softpc/product/command_binding.h"
    "src/app-softpc/product/machine_driver.c"
    "src/app-softpc/product/machine_driver.h"
    "src/app-softpc/product/prompt_trace.c"
    "src/app-softpc/product/prompt_trace.h"
    "src/app-softpc/product/runtime.c"
    "src/app-softpc/product/runtime.h"
    "src/app-softpc/product/input_queue.c"
    "src/app-softpc/product/input_queue.h")
...
foreach(retired_session_source IN ITEMS
    ...
    "src/app-softpc/product/control.h"
    "src/app-softpc/product/control_state.c"
    "src/app-softpc/product/control_state.h"
    "src/app-softpc/product/reconciler.c"
    "src/app-softpc/product/reconciler.h"
    "src/app-softpc/product/presentation_plan.c"
    "src/app-softpc/product/presentation_plan.h")
...
# ownership; those remain in the project binding under src/app-softpc/product.
...
file(STRINGS "${SOFTPC_SOURCE_DIR}/src/app-softpc/softpc.new/base/ccpu386/c-files"
    ccpu_source_names)
foreach(name IN LISTS ccpu_source_names)
    if(NOT name MATCHES "^p\\.")
        list(APPEND standalone_sources
            "${SOFTPC_SOURCE_DIR}/src/app-softpc/softpc.new/base/ccpu386/${name}")
    endif()
endforeach()
...
file(READ "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/platform.c"
    standalone_platform)
...
file(GLOB_RECURSE duplicate_original_headers
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/gdpvar.h"
    "${SOFTPC_SOURCE_DIR}/src/app-softpc/compat/sas4gen.h")
...
list(REMOVE_ITEM unit_test_sources
    "${SOFTPC_SOURCE_DIR}/test/app-softpc/integration/package_smoke.c"
    "${SOFTPC_SOURCE_DIR}/test/app-softpc/integration/runtime_restart_boot_smoke.c")
...
if(NOT EXISTS "${SOFTPC_SOURCE_DIR}/test/app-softpc/integration/package_smoke.c")
