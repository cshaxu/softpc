...
#define isDR0(oprinf) (isDREG(oprinf) && (oprinf).dreg == DREG_DR0)
#define isDR1(oprinf) (isDREG(oprinf) && (oprinf).dreg == DREG_DR1)
#define isDR2(oprinf) (isDREG(oprinf) && (oprinf).dreg == DREG_DR2)
#define isDR3(oprinf) (isDREG(oprinf) && (oprinf).dreg == DREG_DR3)
#define isDR6(oprinf) (isDREG(oprinf) && (oprinf).dreg == DREG_DR6)
#define isDR7(oprinf) (isDREG(oprinf) && (oprinf).dreg == DREG_DR7)
#define isTR6(oprinf) (isTREG(oprinf) && (oprinf).treg == TREG_TR6)
#define isTR7(oprinf) (isTREG(oprinf) && (oprinf).treg == TREG_TR7)
