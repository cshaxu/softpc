/*
 * Original SoftPC Win32 graphics coordinator, preserved for standalone use.
 *
 * The standalone branch keeps the original standard-colour paint vectors and
 * nt_set_paint_routine state machine.  Its only omitted actions are product
 * console resizing/focus transitions; DIB allocation and presentation are
 * provided by softpc_standalone_dib.c and the VM window.
 */
