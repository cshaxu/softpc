...
/* This component normalizes Win32 input only.  It emits physical Win32 key
 * records through a project binding and neither knows nor maps any guest
 * keyboard/controller protocol. */
typedef int (*win32_presentation_key_sink)(void *context,
...
int win32_presentation_keyboard_submit_utf16(
    ...
    win32_presentation_key_sink sink, WORD code_unit);
