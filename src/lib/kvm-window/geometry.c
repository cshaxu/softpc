...
int kvm_window_fit_outer_rect(const kvm_window_rect *work_area, int desired_width,
    int desired_height, kvm_window_rect *fitted)
{
    int available_width;
...
int kvm_window_fit_client_size(const kvm_window_rect *work_area, int decoration_width,
...
int kvm_window_fit_aspect_size(int available_width, int available_height,
