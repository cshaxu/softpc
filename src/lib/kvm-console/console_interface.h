...
/* Text only: malformed arguments return INVALID_ARGUMENT; valid graphics return
 * UNSUPPORTED, including after STOP. Neither rejection changes pending output
 * or wakes the worker. Valid text after STOP returns INVALID_STATE. */
