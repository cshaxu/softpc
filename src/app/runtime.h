...
#define SOFTPC_RUNTIME_DIB_MAX_WIDTH KVM_GRAPHICS_MAX_WIDTH
#define SOFTPC_RUNTIME_DIB_MAX_HEIGHT KVM_GRAPHICS_MAX_HEIGHT
#define SOFTPC_RUNTIME_DIB_MAX_BYTES KVM_GRAPHICS_MAX_PIXELS
