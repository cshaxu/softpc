...
/* A UX producer belongs to one VM run. Once the product has stopped accepting
 * guest input, even a same-generation retirement event is too late to enter
 * the machine path. Monitor lines and completion facts use separate rules. */
