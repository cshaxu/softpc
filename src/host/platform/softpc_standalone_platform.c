...
{
    half_word disk = 0u;
    if (softpc_hdd_media_config_path(0u) != NULL &&
        softpc_hdd_media_config_path(0u)[0] != '\0')
        disk = 0x30u;
    if (softpc_hdd_media_config_path(1u) != NULL &&
        softpc_hdd_media_config_path(1u)[0] != '\0')
        disk |= 0x04u;
    return disk;
}
...
void *values;
{
    ...
    if (host_id == SOFTPC_CONFIG_HARD_DISK1_NAME)
        return (void *)(softpc_hdd_media_config_path(0u) != NULL ? softpc_hdd_media_config_path(0u) : softpc_empty_config_value);
    if (host_id == SOFTPC_CONFIG_HARD_DISK2_NAME)
        return (void *)(softpc_hdd_media_config_path(1u) != NULL ? softpc_hdd_media_config_path(1u) : softpc_empty_config_value);
...
UTINY host_id;
{
    if (host_id < SOFTPC_CONFIG_HARD_DISK1_NAME ||
        ...
        return FALSE;
    return softpc_hdd_media_config_path(host_id -
