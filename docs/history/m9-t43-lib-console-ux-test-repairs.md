...
## S7 — Raw Console broker activation experiment

The historical unified Console runner restored native Console foreground as
part of creating its raw reader.  S6 instead added a public focus request and
owner validation rejected that extra app-controlled path.  This bounded
experiment retains no public focus API: the Win32 broker restores the native
