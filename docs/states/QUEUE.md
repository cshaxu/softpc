...
1. [M1 pristine SoftPC recovery and divergence ledger](../proposals/m1-pristine-softpc-recovery.md)
2. [M1 port-ABI overlay extraction](../proposals/m1-port-abi-overlay.md)
3. [M2 host-contract inventory and minimal compatibility surface](../proposals/m2-host-contract-inventory.md)
4. [M2 timer, BOP, and raw-media compatibility](../proposals/m2-host-compat.md)
5. [M2 original renderer compatibility restoration](../proposals/m2-renderer-compat.md)
6. [M2 normalized keyboard, mouse, and audio host contracts](../proposals/m2-input-audio-compat.md)
7. [M3 executor-boundary feasibility](../proposals/m3-executor-feasibility.md)
8. [M3 single-executor runtime and lifecycle mailbox](../proposals/m3-executor-runtime.md)
