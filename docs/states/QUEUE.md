...
2. [Win3.1 MS-DOS prompt display roundtrip repair](../proposals/m9-win31-display-roundtrip.md)
3. [Overlay page lookup optimization](../proposals/m9-overlay-page-index.md)
4. [Snapshot and component architecture simplification](../proposals/m9-snapshot-architecture-simplification.md)
