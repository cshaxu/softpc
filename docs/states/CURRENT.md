...
Two controller/firmware extraction routes remain after restoring the original
PPI controller, incompatible-driver BOP path, CPU_40 keyboard reset path and
CMOS controller through their standalone host contracts. The restoration
