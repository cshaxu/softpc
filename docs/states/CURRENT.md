...
No implementation subtask is active. M9 T69 is closed after its owner-reopened
S4 removed every audit-proven T69-introduced obsolete helper and dead wrapper.
The accepted repair remains a single original-renderer/Compat transaction,
selected-painter width contract, and detached text-surface policy; no new
state, API, renderer, timing filter or product-specific branch was added.
