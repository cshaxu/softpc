...
`--window` reserves the Win32 presentation route.  Console presentation is
the default.  The initial source cut is deliberately staged: it creates the
machine boundary and validates media ownership before the CCPU/SAS/device
packages are linked.
